...
This is a collection of artwork for the Asterinas project.

All artwork in this repository is contributed by the Asterinas community.

## Licenses

Unless otherwise noted, all artwork is licensed under [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) (essentially public domain), with the following exceptions:

| Paths | Licenses | Notes   |
|------|---------|---------|
